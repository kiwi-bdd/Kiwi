...
{
    KWUserDefinedMatcherBlock __unsafe_unretained matcherBlock;
    SEL selector;
...
@property (nonatomic, unsafe_unretained) KWUserDefinedMatcherBlock matcherBlock;
...
@property (unsafe_unretained, nonatomic, readonly) NSString *key;
